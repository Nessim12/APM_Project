...
class ActiveContractManager(models.Manager):
    def get_queryset(self):
        return ContractQuerySet(self.model, using=self._db).actives()


class AllContractManager(models.Manager):
    def get_queryset(self):
...
class Fournisseur(models.Model):
    ...
    archived = models.BooleanField(default=False, verbose_name=_('Archivé'))  # Ensure spacing is consistent
...
class Contract(models.Model):
    ...
    objects = ActiveContractManager()
    all_objects = AllContractManager()
